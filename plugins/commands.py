...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🍿 𝐆𝐑𝐎𝐔𝐏', url='https://t.me/+64EZ_m-nmpE3Mzg1')
            ],
            [
        ...
        await asyncio.sleep(0.5) # 😢 https://github.com/EvamariaTG/EvaMaria/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            👉ഈ channel Join ചെയ്തു back വന്നു refresh കൊടുത്താൽ File കിട്ടും""",
