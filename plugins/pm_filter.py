...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('⚙️ 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 ⚙️', url='https://t.me/ML_LINKS_01'),            
        ], [
        ...
        await query.message.delete()
        await query.message.reply_sticker(        
            sticker="CAACAgUAAxkBAAECsYlivUEfV9m4BlHgvIxYxp9u3R7jfgACPQMAAuD1YFZ5bbz9bHwB_R4E",            
            reply_markup=reply_markup,
        )
    elif query.data == "manuelfilter":
        buttons = [[
            InlineKeyboardButton('👩‍🦯 𝐁𝐀𝐂𝐊', callback_data='help'),
            InlineKeyboardButton('⏹️ 𝐁𝐔𝐓𝐓𝐎𝐍𝐒', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('👩‍🦯 𝐁𝐀𝐂𝐊', callback_data='help'),
            InlineKeyboardButton('👮‍♂️ 𝐀𝐃𝐌𝐈𝐍', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
